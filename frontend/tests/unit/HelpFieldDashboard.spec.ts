...
describe('HelpFieldDashboard.vue', () => {
	...
	it('renders the "Field Information" section', () => {
		...
		expect(wrapper.text()).toContain(
			'After selecting a field, the FieldCard displays key information about the field, including:',
		)
	})
	...
	it('renders the "Viewing Statistics" section', () => {
		...
		expect(wrapper.text()).toContain(
			'The Advanced Statistics panel displays several charts using the StatsCard component, including:',
		)
	})
