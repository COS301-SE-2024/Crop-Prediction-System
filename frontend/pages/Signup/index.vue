      ...
      <div class="flex flex-col gap-5 items-center w-[400px] max-w-lg">
        <Card class="w-full border border-surface-border">
          ...
          <template #content>
            <div class="flex flex-col gap-3">
              <div class="flex flex-col gap-2 items-start">
                ...
                />
                <small v-if="validation.userEmail.$dirty && validation.userEmail.$error" class="text-red-500">{{ validation.userEmail.$message }}</small>
              </div>
              <div class="flex flex-col gap-2 items-start">
		  ...
		  <small v-if="!passwordsMatch" class="w-full text-red-500">Passwords do not match</small>
              ...
              <Button class="w-full" label="Sign up" @click="signUp" :disabled="validation.$anyError || userEmail === '' || !password || !confirmPassword || password !== confirmPassword"/>
