...
export function useFieldData() {
	...
	const chartDataList = reactive({
		soilMoisture: { title: 'Soil Moisture', chartData: {}, subtitle: 'The amount of water in the soil as a percentage', unit: '%' },
		soilTemperature: { title: 'Soil Temperature (°C)', chartData: {}, subtitle: 'The temperature of the soil in degrees Celsius', unit: '°C' },
		sprayability: { title: 'Sprayability', chartData: {}, subtitle: 'The suitability to spray chemicals on crops', unit: '%' },
		precipitation: { title: 'Precipitation (mm)', chartData: {}, subtitle: 'The amount of rain that has fallen in millimeters', unit: 'mm' },
		temperature: { title: 'Temperature (°C)', chartData: {}, subtitle: 'The temperature in degrees Celsius', unit: '°C' },
		dewPoint: { title: 'Dew Point (°C)', chartData: {}, subtitle: 'The temperature at which air becomes saturated with water vapor', unit: '°C' },
		humidity: { title: 'Humidity', chartData: {}, subtitle: 'The amount of water vapor in the air as a percentage', unit: '%' },
