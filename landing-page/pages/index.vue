					...
					<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						...
						>
							<div class="bg-surface-0 dark:bg-surface-900 h-full p-6 rounded-lg">
								...
								<h3 class="text-xl font-semibold text-surface-900 dark:text-surface-0 mb-2">Easy to Use</h3>
						...
						>
							<div class="bg-surface-0 dark:bg-surface-900 h-full p-6 rounded-lg">
								<div
									class="flex items-center justify-center w-12 h-12 bg-cyan-200 dark:bg-cyan-700 rounded-lg mb-4"
								>
									<i class="pi pi-palette text-2xl text-cyan-700 dark:text-cyan-200"></i>
								</div>
								<h3 class="text-xl font-semibold text-surface-900 dark:text-surface-0 mb-2">Fresh Design</h3>
								<p class="text-surface-600 dark:text-surface-200">
						...
						>
							<div class="bg-surface-0 dark:bg-surface-900 h-full p-6 rounded-lg">
								...
								<h3 class="text-xl font-semibold text-surface-900 dark:text-surface-0 mb-2">Well Documented</h3>
								<p class="text-surface-600 dark:text-surface-200">
