...
const fixedData = {
	...
	Humidity: [75, 72, 68, 65, 60, 70, 67, 66, 64, 61, 59, 68, 66, 70],
	Rainfall: [15.5, 8, 0, 2, 18.9, 5.0, 7.1, 15.4, 20.8, 35.2, 28.5, 30.1, 25.7, 15.9],
	SoilMoisture: [40.0, 39.5, 38.0, 40.5, 38.5, 34.2, 31.5, 30.5, 30.0, 32.0, 34.0, 36.0, 37.5, 39.0],
	SoilTemperature: [20.5, 20.1, 20.8, 21.5, 22.0, 21.5, 22.0, 21.0, 21.2, 20.9, 21.0, 21.5, 21.8, 21.2],
